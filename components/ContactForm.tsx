...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send silently via Web3Forms API
    ...
    return (
      <div className="bg-[#D4FF3F] p-12 md:p-20 rounded-[3rem] text-[#0F211D] animate-in zoom-in duration-500 shadow-2xl border border-white/20">
        ...
        <button 
          ...
          className="px-10 py-4 bg-[#0F211D] text-white rounded-full font-black uppercase tracking-widest text-xs hover:scale-105 transition-transform"
        >
          Send Another
        </button>
      </div>
  ...
  return (
    <div className="relative p-8 md:p-12 lg:p-16 rounded-[3rem] bg-white/10 backdrop-blur-3xl border border-white/20 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] overflow-hidden group">
