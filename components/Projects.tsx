    ...
    <div className="relative w-full bg-white">
      ...
      <div className="px-6 md:px-12 lg:px-20 pt-4 md:pt-8 mb-8 md:mb-12">
        <div className="max-w-5xl">
          <div className="text-5xl md:text-[clamp(4rem,10vw,8rem)] lg:text-[12vw] font-heading font-black text-[#0F211D] leading-[1.0] md:leading-[0.95] lg:leading-[0.9] tracking-tighter">
      ...
      <div className="mt-16 md:mt-32 px-6 md:px-20 flex justify-center pb-32 md:pb-64">
        ...
        >
           <span className="relative z-10 text-[12px] md:text-[14px] font-black uppercase tracking-[0.4em] md:tracking-[0.6em] text-[#0F211D] group-hover:text-white">Start a New Project</span>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 lg:p-20 flex flex-col md:flex-row items-end justify-between gap-6 md:gap-10">
          <div className="space-y-4 md:space-y-6 max-w-2xl">
            ...
            <p className="text-base md:text-lg lg:text-xl font-medium text-white/80 max-w-lg leading-relaxed">
              {project.description}
            </p>
